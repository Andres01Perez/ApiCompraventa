...
namespace ApiCompraventa.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Articulos_Categoriass_CategoriaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FotoArticulos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FotoArticulos_Articulos_ArticuloId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Historiales_Articulos_articuloId",
                        column: x => x.articuloId,
                        principalTable: "Articulos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Detalless", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Detalless_Estados_EstadoId",
                        column: x => x.EstadoId,
                        principalTable: "Estados",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Detalless_Historiales_HistorialId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Detalless_EstadoId",
                table: "Detalless",
                column: "EstadoId");

            migrationBuilder.CreateIndex(
                name: "IX_Detalless_HistorialId",
                table: "Detalless",
                column: "HistorialId");

            migrationBuilder.CreateIndex(
                name: "IX_FotoArticulos_ArticuloId",
                table: "FotoArticulos",
                column: "ArticuloId");

            migrationBuilder.CreateIndex(
                name: "IX_Historiales_articuloId",
                table: "Historiales",
                column: "articuloId");
        }
